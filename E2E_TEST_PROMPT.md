# E2E Real Integration Test — Prompt for Claude Code
# Use this AFTER all unit tests pass and all real API keys are in .env
# Run this at the end of each phase to verify the real product works
...
3. TWILIO: check Twilio console logs at console.twilio.com
   ...
   → verify to_number = +15559876 (the number from Turn 3)
...
```
Expected:
- Missed call recovery SMS sent to +15550000000 via real Twilio
